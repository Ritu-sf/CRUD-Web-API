package com.salesken.network.controller;
...
import com.salesken.network.entity.CreateConnectionRequest;
...
public class SaleskenController {
	...
	public JSONObject modifyStrength(@RequestBody JSONObject modifyStrength) {
		String msg = networkService.modifyStrength(modifyStrength.get("deviceName").toString(),
				Integer.parseInt(modifyStrength.get("strength").toString()), false);
		JSONObject obj = new JSONObject();
		obj.put("msg", msg);
		return obj;
	}
	...
	public JSONObject deleteDevice(@RequestBody JSONObject deletNode) {
		String msg = networkService.deleteDevice(deletNode.get("deviceName").toString());
		JSONObject obj = new JSONObject();
		obj.put("msg", msg);
		return obj;
	}
